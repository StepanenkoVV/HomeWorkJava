...
public class Main {
  ...
  public static void main(String[] args) {
    System.out.println(splitTextIntoWords(
        "Every-one could ++++ notice that people often complain and say that it was better before. It may be a little nostalgia;\n"
            ...
            + "Everyone has a shower, a TV2021, a fridge, a computer, etc. And now there are more means of communication\n"
