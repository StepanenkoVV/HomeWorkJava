...
public class Main {
    ...
    private static Logger  loggerExceptionLogger;
    private static Logger loggerSearchLogger;
    private static Logger loggerMistakeLogger;
    ...
    public static void main(String[] args) {
        ...
        loggerSearchLogger =  LogManager.getLogger("SearchStation");
        loggerMistakeLogger = LogManager.getLogger("MistakeStation");
        loggerExceptionLogger = LogManager.getLogger("ExceptionLogg");
        ...
        for (; ; ) {
            ...
            System.out.println("Длительность: " +
                ...
                loggerExceptionLogger.info("Exception " + exception);
            }
        }
    }
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                loggerSearchLogger.info("Вы искали станцию " + line);
                return station;
            }
            loggerMistakeLogger.info("Станция не найдена  " + line);
